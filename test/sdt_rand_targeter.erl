...
init({Creation, Port}) ->
    %% Default seed: 1222, 1362
    Timeout = 1000 + random:uniform(500),
    Manager = {manager, {sdt_simple, start_link, [2]},
               permanent, 5000, worker, [sdt_simple, sd_simple]},
    Targeter = {targeter, {sd_targeter, start_link, [[], Timeout]},
